...
<ul class="list-unstyled">
  ...
  <li>Agricultural By-Products Lab 
    (See <a href="{{ '/texts/buildings/155day-nuclear-engineering-lab/' | relative_url }}">Nuclear Engineering Bldg.</a>) </li>
  ...
  <li><a href="{{ '/texts/007day-special-areas/#veterinary-medicine-research-institute' | relative_url }}">Animal Isolation Building & Addition</a></li>
  ...
  <li>Auditorium (See <a href="{{ '/texts/buildings/207day-cy-stephens-auditorium/' | relative_url }}">Stephens Auditorium</a>)</li>
...
<ul class="list-unstyled">
  ...
  <li><a href="{{ '/texts/004day-transportation/#bus' | relative_url }}">Buses</a></li>
...
<ul class="list-unstyled">
  ...
  <li><a href="{{ '/texts/006day-utilities/#steam-distribution-tunnels-and-chilled-water' | relative_url }}">Chilled Water</a></li>
  ...
  <li><a href="{{ '/texts/005day-athletic-rec/#athletic-fields' | relative_url }}">Clyde Williams Field</a></li>
...
<ul class="list-unstyled">
  ...
  <li>Design Center (See <a href="{{ '/texts/buildings/042day-college-design/' | relative_url }}">College of Design</a>)</li>
  ...
  <li>Domestic Economy Hall (See <a href="{{ '/texts/buildings/201day-south-hall/' | relative_url }}">South Hall</a>)</li>
...
<ul class="list-unstyled">
  ...
  <li>Forage Shop (See <a href="{{ '/texts/buildings/030day-building-b/' | relative_url }}">Building "B"</a>)</li>
  ...
  <li><a href="{{ '/texts/buildings/083day-freeman-hall/' | relative_url }}">Freeman Hall</a></li>
...
<ul class="list-unstyled">
  ...
  <li><a href="{{ '/texts/buildings/118day-judging-pavilion/' | relative_url }}">Judging Pavilion</a></li>
...
<ul class="list-unstyled">
  ...
  <li><a href="{{ '/texts/buildings/214day-town-engineering/' | relative_url }}">Town Engineering Building</a></li>
...
<ul class="list-unstyled">
  ...
  <li><a href="{{ '/texts/1000day-minor-buildings/#wood-shed-at-south-hall' | relative_url }}">Wood Shed - at South Hall</a></li>
  <li><a href="{{ '/texts/buildings/228day-workshop/' | relative_url }}">Workshop</a></li>
</ul>
